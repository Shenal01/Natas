...
<h1>natas11</h1>
<div id="content">
    <body style="background: <?php echo $data["bgcolor"]; ?>;">
    ...
    <form>
        Background color: <input name="bgcolor" value="<?php echo $data["bgcolor"]; ?>">
        <input type="submit" value="Set color">
    </form>
    <div id="viewsource"><a href="index-source.html">View source code</a></div>
</div>
</html>
